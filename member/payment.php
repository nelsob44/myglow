...
//Redirect
$redirectUrls->setReturnUrl('http://localhost:1234/phpcourse/paypal/pay.php?approved=true')
    ->setCancelUrl('http://localhost:1234/phpcourse/paypal/pay.php?approved=false');
...
try {
    ...
    $store = $con->prepare("INSERT INTO transactions_paypal (user_id, payment_id, hash, complete) VALUES (':user_id', 'payment_id', 'hash', 0)");
