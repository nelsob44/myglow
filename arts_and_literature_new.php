...
?>
    ...
    <div class="forum_container">
        ...
        <form class="form-control" action="arts_and_literature_new.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control forum_post" name="forum_post" id="forum_post" rows="7"></textarea>
            </div>
           <div class="form-group">
...
if(isset($_POST['post'])) {
    ...
    if($uploadOk) {
        ...
        $topic->submitTopicArtsAndLiterature($title, $post, $imagePath);
    }
    else {
    ...
    header("Location: arts_and_literature.php?page=1");
