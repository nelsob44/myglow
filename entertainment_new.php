...
?>
    ...
    <div class="forum_container">
        ...
        <form class="form-control" action="entertainment_new.php" method="POST" enctype="multipart/form-data">
...
if(isset($_POST['post'])) {
    ...
    if($uploadOk) {
        ...
        $topic->submitTopicEntertainment($title, $post, $imagePath);
    }
    else {
    ...
    header("Location: entertainment.php?page=1");
