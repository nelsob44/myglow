        ...
        if(mysqli_num_rows($data_query) > 0) {
            ...
            while($row = mysqli_fetch_array($data_query)) {
                ...
                if($row['user_to'] == "none") {
                    ...
                    $user_to = "<i class='fas fa-arrow-right'></i> <a href='" .$row['user_to']."'>" .$user_to_name. "</a>";
                }
                ...
                if($user_logged_obj->isFriend($added_by)) {
                    ...
                    if($num_iterations++ < $start)
                        continue;
                    //once 'limit' number of posts have been loaded, break
                    if($count > $limit) {
                        break;
                    }
                    else {
                    ...
                    $str .= "<div class='status_post' onClick='javascript:toggle$id()'>
                            ...
                            </div><div class='fb-share-button' data-href='http://localhost:1234/phpcourse/index.php' data-layout='button_count' data-size='small' data-mobile-iframe='true'><a target='_blank' href='https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Flocalhost%3A1234%2Fphpcourse%2Findex.php&amp;src=sdkpreparse' class='fb-xfbml-parse-ignore'>Share</a></div>
                            <hr>";
                }
                ?>
                <script>
