...
class Notification {
    ...
    public function getNotifications($data, $limit) {
        ...
        while($row = mysqli_fetch_array($query)) {
            ...
            $return_string .= "<a href='".$row['link']."'>
                                ...
                                <p class='timestamp_smaller' id='grey'>".$time_message."</p>".$row['messages']."
                                </div>
                                </a>";
        }
        ...
        if($count > $limit)
            ...
            $return_string .="<input type='hidden' class='nextPageDropdownData' value='true'><p style='text-align: center;'>No more notifications to load!</p>";
    ...
    public function insertForumNotification($forum_post_id, $user_to, $type) {
        $userLoggedIn = $this->user_obj->getUsername();
        $userLoggedInName = $this->user_obj->getFirstAndLastName();
        ...
        $link = "post_details.php?forum_post_id=" . $forum_post_id."&page=1";
