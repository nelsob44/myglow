...
class User {
    ...
    public function getNumPhotos() {
      $username = $this->user['username'];
      $photo_num_query = mysqli_query($this->con, "SELECT num_photos FROM users WHERE username='$username'");
      $row = mysqli_fetch_array($photo_num_query);
    ...
    public function getCountry() {
      $username = $this->user['username'];
      $query = mysqli_query($this->con, "SELECT country FROM users WHERE username='$username'");
      $row = mysqli_fetch_array($query);
      return $row['country'];
    }
    ...
    public function getCity() {
      $username = $this->user['username'];
      $query = mysqli_query($this->con, "SELECT city FROM users WHERE username='$username'");
      $row = mysqli_fetch_array($query);
      return $row['city'];
    }
    ...
    public function getTotalUsers() {
        $query = mysqli_query($this->con, "SELECT * FROM users WHERE user_closed='no'");
        return mysqli_num_rows($query);
    }

    public function getUsersOnline() {
        $query = mysqli_query($this->con, "SELECT * FROM users WHERE user_online='yes'");
        return mysqli_num_rows($query);
    }
