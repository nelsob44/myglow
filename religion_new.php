...
?>
    ...
    <div class="forum_container">
        ...
        <form class="form-control" action="religion_new.php" method="POST" enctype="multipart/form-data">
...
if(isset($_POST['post'])) {
    ...
    if($uploadOk) {
        ...
        $topic->submitTopicReligion($title, $post, $imagePath);
    }
    else {
    ...
    header("Location: religion.php?page=1");
