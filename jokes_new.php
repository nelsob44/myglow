...
?>
    ...
    <div class="forum_container">
        ...
        <form class="form-control" action="jokes_new.php" method="POST" enctype="multipart/form-data">
...
if(isset($_POST['post'])) {
    ...
    if($uploadOk) {
        ...
        $topic->submitTopicJokes($title, $post, $imagePath);
    }
    else {
    ...
    header("Location: jokes.php?page=1");
