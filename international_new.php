...
?>
    ...
    <div class="forum_container">
        ...
        <form class="form-control" action="international_new.php" method="POST" enctype="multipart/form-data">
...
if(isset($_POST['post'])) {
    ...
    if($uploadOk) {
        ...
        $topic->submitTopicInternational($title, $post, $imagePath);
    }
    else {
    ...
    header("Location: international.php?page=1");
