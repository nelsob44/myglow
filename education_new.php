...
?>
    ...
    <div class="forum_container">
        ...
        <form class="form-control" action="education_new.php" method="POST" enctype="multipart/form-data">
...
if(isset($_POST['post'])) {
    ...
    if($uploadOk) {
        ...
        $topic->submitTopicEducation($title, $post, $imagePath);
    }
    else {
    ...
    header("Location: education.php?page=1");
