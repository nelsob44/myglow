...
?>
    ...
    <div class="forum_container">
        ...
        <form class="form-control" action="romance_and_relationships_new.php" method="POST" enctype="multipart/form-data">
...
if(isset($_POST['post'])) {
    ...
    if($uploadOk) {
        ...
        $topic->submitTopicRomanceAndRelationships($title, $post, $imagePath);
    }
    else {
    ...
    header("Location: romance_and_relationships.php?page=1");
