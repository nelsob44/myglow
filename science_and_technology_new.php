...
?>
    ...
    <div class="forum_container">
        ...
        <form class="form-control" action="science_and_technology_new.php" method="POST" enctype="multipart/form-data">
...
if(isset($_POST['post'])) {
    ...
    if($uploadOk) {
        ...
        $topic->submitTopicScienceAndTechnology($title, $post, $imagePath);
    }
    else {
    ...
    header("Location: science_and_technology.php?page=1");
