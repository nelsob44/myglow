...
?>
    ...
    <div class="forum_container">
        ...
        <form class="form-control" action="sports_new.php" method="POST" enctype="multipart/form-data">
...
if(isset($_POST['post'])) {
    ...
    if($uploadOk) {
        ...
        $topic->submitTopicSports($title, $post, $imagePath);
    }
    else {
    ...
    header("Location: sports.php?page=1");
