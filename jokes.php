...
<div class="container-fluid forum_container">
        <div class="forum_body_container_topics">
            ...
            <div class="new_posts"><a href="forum.php" target="_parent"><small style="font-size:11;">Active users: <?php echo $active_users; ?></small></a>&nbsp;&nbsp;
              <a href="forum.php" target="_parent"><small style="font-size:11;">Users online: <?php echo $users_online; ?></small></a>&nbsp;&nbsp;<a href='jokes_new.php'><small>Create a new post /</small></a></div>
           <div class="politics_area">
             <?php
             $topic = new Topic($con, $userLoggedIn);
             $topic->loadTopicJokes();
             ?>
           </div>
            ...
            <div class="pagination_div">
             ...
             $page = $_GET['page'];
            $data_query = mysqli_query($con, "SELECT * FROM forum_topics WHERE category='jokes'");
             ...
             $limit = 4;
                 if ($pages >=1 && $page <= $pages) {
                     ...
                     $link = "";
                     if ($page >= ($limit/2)) {
                       $link .="<a href=jokes.php?page=1>1</a>...&nbsp;";
                     }
                     for ($i=$page; $i<=$pages; $i++) {
                       if($counter < $limit) {
                         $link .="<a href=jokes.php?page=".$i.">".$i."</a>&nbsp;";
                       }
                       $counter++;

                     }
                     if ($page < $pages - ($limit/2)) {
                       $link .="..."."<a href=jokes.php?page=".$pages.">".$pages."</a>&nbsp;";
                     }
