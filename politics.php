...
<div class="container-fluid forum_container">
        ...
        <div class="forum_body_container_topics">
           ...
           <div class="pagination_div">
             ...
             $page = $_GET['page'];
             $data_query = mysqli_query($con, "SELECT * FROM forum_topics WHERE category='politics'");
             ...
             $limit = 4;
                 if ($pages >=1 && $page <= $pages) {
                     ...
                     $link = "";
                     if ($page >= ($limit/2)) {
                       $link .="<a href=politics.php?page=1>1</a>...&nbsp;";
                     }
                     for ($i=$page; $i<=$pages; $i++) {
                       if($counter < $limit) {
                         $link .="<a href=politics.php?page=".$i.">".$i."</a>&nbsp;";
                       }
                       $counter++;

                     }
                     if ($page < $pages - ($limit/2)) {
                       $link .="..."."<a href=politics.php?page=".$pages.">".$pages."</a>&nbsp;";
                     }
