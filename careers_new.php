...
?>
    ...
    <div class="forum_container">
        ...
        <form class="form-control" action="careers_new.php" method="POST" enctype="multipart/form-data">
...
if(isset($_POST['post'])) {
    ...
    if($uploadOk) {
        ...
        $topic->submitTopicCareers($title, $post, $imagePath);
    }
    else {
    ...
    header("Location: careers.php?page=1");
