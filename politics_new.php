...
?>
    ...
    <div class="forum_container">
        ...
        <form class="form-control" action="politics_new.php" method="POST" enctype="multipart/form-data">
...
if(isset($_POST['post'])) {
    ...
    if($uploadOk) {
        ...
        $topic->submitTopicPolitics($title, $post, $imagePath);
    }
    else {
    ...
    header("Location: politics.php?page=1");
